...
export const PERSONAL_INFO = {
  ...
  bio: "Final-year Computer Science Engineering (AI & ML) student passionate about building intelligent software, AI-powered applications, backend systems, and real-world machine learning solutions. I enjoy solving practical problems using AI, automation, Python, FastAPI, and modern software engineering.",
